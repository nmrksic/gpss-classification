...
\clearpage
%\section{$ \SE_1 + \SE_2 + \SE_3$}


\begin{table}

\caption*{{ True kernel: $ \SE_1 + \SE_2 + \SE_3$, $D$ = 3. Cumulative Gaussian likelihood.  }}
...
\hline Data size & SNR & sp\_noise &  Kernel chosen & Test accuracy & Kernel rate & Function rate \\
...
\caption*{{ True kernel: $ \SE_1 + \SE_2 + \SE_3$, $D$ = 3. Saturating likelihood function.          }}
...
\hline Data size & SNR & sp\_noise &  Kernel chosen & Test accuracy & Kernel rate & Function rate & Noise ratio \\
...
\begin{table}
\caption*{{ True kernel: $ \SE_1 + \SE_2 \times \SE_3 + \SE_4$,  $D$ = 4.  Cumulative Gaussian likelihood.          }}
...
\caption*{{ True kernel: $ \SE_1 + \SE_2 \times \SE_3 + \SE_4$,  $D$ = 4.    Saturating likelihood function.      }}
...
\begin{table}
\caption*{{True kernel: $ \SE_1 + \SE_3 \times \SE_7 + \SE_{10}$,  $D$ = 10. Cumulative Gaussian likelihood.  }} 
...
\caption*{{ True kernel: $ \SE_1 + \SE_3 \times \SE_7 + \SE_{10}$,  $D$ = 10. Saturating likelihood function.        }}
...
\clearpage
 ...
 \begin{table}
\caption*{\small{ True kernel: $\SE_1 + \SE_3 \times \SE_5 \times \SE_7 + \SE_{9}$,  $D$ = 10. Cumulative Gaussian likelihood.  }} 
...
\caption*{{ True kernel: $\SE_1 + \SE_3 \times \SE_5 \times \SE_7 + \SE_{9}$,  $D$ = 10. Saturating likelihood.    }}
