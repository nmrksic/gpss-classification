function [bestKernel, bestBicVal, bestHypers] = nextKernelParallel (kernelMatrix, kernelHypers, dataDim, X, y, numExp, runParallel, inferenceMethod, selectFeatures)
...
if (nargin < 7)
 ...
 trueIdx = int32(floor(bestId / numExp) + 1);
